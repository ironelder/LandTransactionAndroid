            ...
            Row(
                ...
                TextButton(
                    ...
                    Text(
                        text = "OK",
                        style = MaterialTheme.typography.button,
                        color = Color.White//MaterialTheme.colors.onPrimary
                    )
                }
...
fun CustomCalendarView(onDateSelected: (LocalDate) -> Unit) {
    ...
    AndroidView(
        ...
        factory = { context ->
            CalendarView(ContextThemeWrapper(context, R.style.Theme_LandTransaction))
        },
        update = { view ->
//            view.minDate = 20201020// contraints
            view.maxDate = Date().time// contraints
